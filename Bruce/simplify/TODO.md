...
> ⚠️ **本文档已基本过时。** 🔴 Bug 1~5 在代码中已全部修复（接口统一、使能/归零/清错/控制帧下发、SendThreadFunc 均已实现）；实际电机数为 **16**（4×4，含轮电机）而非 12；`RobotDog` 层与"示例 2/3/4"始终未实现。当前架构见 `FRAMEWORK_GUIDE.md` 与 `MOTOR_MANAGER_GUIDE.md`。
