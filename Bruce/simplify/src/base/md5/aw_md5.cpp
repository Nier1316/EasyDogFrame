 ...
 */
void
aw_md5_init (aw_md5_t *mdContext)
{
 ...
 */
void
aw_md5_update(aw_md5_t *mdContext, unsigned char *inBuf, unsigned int inLen)
{
  u32_t in[16];
  int mdi;
  unsigned int i, ii;
 ...
 */
void
aw_md5_final (unsigned char hash[], aw_md5_t *mdContext)
{
  u32_t in[16];
  int mdi;
  unsigned int i, ii;
  ...
  aw_md5_update (mdContext, PADDING, padLen);
